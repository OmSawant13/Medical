  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.role === 'patient') {
        ...
        registrationData.specialization = formData.specialization ? [formData.specialization] : [];
        registrationData.licenseNumber = formData.license;
        registrationData.experience = 0;
        registrationData.qualifications = [];
